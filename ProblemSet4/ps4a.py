...
WORDLIST_FILENAME = "C:\Users\Dhananjay.Pandit-PC\Documents\edX Courses\Introduction to Computer Science and Programming\Week 4\ProblemSet4\words.txt"
...
def getWordScore(word, n):
    ...
    points=0
    wordl=[]
    #assert len(word)<=n,"Letters are REUSED!"
    for w in word:
        wordl.append(w)
    for char in wordl:
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while inc!='.':
        ...
        for h in handList:
            print h,
        print
        inc=raw_input('Enter word, or a "." to indicate that you are finished:')
        if inc=='.':
            print "Goodbye! Total score: "+str(total)+" points"
            break
        if isValidWord(inc,hand,wordList)==True:
        ...
        elif isValidWord(inc,hand,wordList)==False:
